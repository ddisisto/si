...
- when we have a working game event system - maybe as a nod to recursion, the player can acheive "<org> Releases a game fully generated by AI" #vibecoding #aislop #viral "Better than Plague, Inc., bigger than FlappyBirds"
- i'd like to make sure we have a research and deployment category for increasingly agentic tools and frameworks, just like Claude Code. Maybe an easter egg hiding within ;)